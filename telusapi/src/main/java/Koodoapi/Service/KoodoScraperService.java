...
public class KoodoScraperService {
    ...
    public KoodoScraperService() {
        ...
        System.setProperty("web driver.chrome.driver", "C:\\Users\\Sayansinh\\Downloads\\faraz web scraping\\web-scraping-selenium\\chromedriver-win64");
